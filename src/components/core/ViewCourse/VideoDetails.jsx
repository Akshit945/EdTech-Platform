...
const VideoDetails = () => {
    ...
    ;(async () => {
      ...
      if (!courseId && !sectionId && !subSectionId) {
        ...
        const filteredData = courseSectionData.filter(  
          (course) => course._id === sectionId   //section nika liya
        )
  ...
  const isFirstVideo = () => {  //section and subsection is index=0
  ...
  const goToNextVideo = () => {
    ...
    } else { //next section ki first video me jao
